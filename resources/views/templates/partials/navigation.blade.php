...
::selection{
  background: black;
    ...
    <nav class="nav navbar-default dark" role="navigation" style="background-color:rgb(0, 0, 0);">
        <div id="logo"><a class="navbar-brand" href="{{ route('home') }}"><p class="logo">h3x4 <span class="logo">|</span></p></a></div>
		...
		@if (Auth::check())
		            <!-- First Tier Drop Down -->
		            <label for="drop-1" class="toggle"><span></span> +</label>
		                <a href="{{ route('profile.index', ['username' => Auth::user()->username]) }}"></a>
