 ...
 */
    ...
    $outputFile = $QR_BASEDIR.'./resources/views/QRCode/phpqrcode.php';
    ...
    $headerFile = $QR_TOOLSDIR.'./resources/views/QRCode/tools/merged_header.php';
    $versionFile = $QR_BASEDIR.'./resources/views/QRCode/VERSION';
    
    $outputCode = './public/images/QRCode';
