    	...
    	<div class="col-lg-5">
    		...
    		@else
    			@foreach ($statuses as $status)
					...
					<img class="media-object" alt="{{ Auth::user()->getNameOrUsername() }}" src="./public/images/uploads/avatars/{{ $status->user->avatar }}" style="width:40px; height:40px; float:left; border-radius:30%; margin-right:25px;"></a>
					<div class="media-body">
						...
						@foreach ($status->replies as $reply)
							<div class="media">
								...
								<img class="media-object" alt="{{ Auth::user()->getNameOrUsername() }}" src="./public/images/uploads/avatars/{{ $reply->user->avatar }}" style="width:40px; height:40px; float:left; border-radius:30%; margin-right:25px;"></a>
								<div class="media-body">
